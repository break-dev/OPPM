...
<html lang="es">
	...
	<body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
		...
		<script type="text/javascript">
          ...
          // Grabando Datos
            $.post( "apis/backend.php", { accion: "grabar_cliente", modo_grabar: modo_grabar, id_cliente: id_cliente, cod_condicion: 2, cod_tipocliente: cod_tipocliente, cod_tipodocumento: cod_tipodocumento, documento: documento, razon_social: razon_social, telefono1: telefono1, telefono2: telefono2, correo: correo, direccion: direccion },
              function( data ) {
                if (data.estado == 2){
