...
<head>
	...
	<title><?php echo $nom_app; ?> | Cumplimiento - Lote</title>
...
<section>
	<div class="container-fluid" id="content">
							...
							<div class="row" style="padding-left: 30px; margin-top: -5px; margin-bottom: 10px; font-size: 13px;">
								...
								<div class="col-md-4 col-sm-4 col-xs-12" style="padding: 2px;">
									<div style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; padding: 10px;">
										...
										<div class="d-flex" style="margin-top: -5px; padding-left: 10px; padding-right: 10px;">
											<span class="span_select2_cliente" style="position:relative; width: 100% !important;">
		...
		<script type="text/javascript">
			...
			// Titulo de Pantalla
				$("#nv_titulo").html('| Cumplimiento - Lote');
		...
		<script type="text/javascript">
			...
			var parentElementProveedor = $(".span_select2_cliente");
     	  ...
     	  dropdownParent: parentElement,
		    ...
		    placeholder: $( this ).data( 'placeholder' ),
	     	//dropdownParent: $('#body-inner'),
     	  dropdownParent: parentElementProveedor,
		    width: $( this ).data( 'width' ) ? $( this ).data( 'width' ) : $( this ).hasClass( 'w-100' ) ? '100%' : 'style',
		    allowClear: false
			});
		...
		<script type="text/javascript">
			...
			function f_LoadResultados(){
				...
				$.post( "apis/backend.php", { accion: "get_ListaDetalleControlInternoLotes", filtro_cliente: filtro_cliente, id_origendato: id_origendato, filtro_porcentaje: filtro_porcentaje,filtro_lote: filtro_lote, fecha_inicio: fecha_inicio, fecha_fin: fecha_fin }, 
					function( data ) {
						if(data.estado == 1){
					...
					function( data ) {
						if(data.estado == 1){
							...
							$.each( data.res, function( key, val ) {
								...
								_html += '  <td class="row-sticky-6" style="border: solid; border-width: 1px; border-color: #D9D9D9; vertical-align: middle; text-align: center; background-color: #fff">';
								_html += '      ' + val.razon_social;
								_html += '  </td>';
			...
			function f_AddFileGestionDocumentaria(_id_tipo_dato, _id_cliente,_is_principal){
				...
				inputFile.on('change', function() {
			    	...
			    	//Insertar
						...
						formDataGestionDocumentaria.append('accion', 'grabar_GestionDocumentariaFileLote');
						$.ajax({
							url: 'apis/backend.php',
							type: 'POST',
