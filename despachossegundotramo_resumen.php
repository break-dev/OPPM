									...
									<div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 20px; padding-right: 20px; margin-top: 5px; width: 100%;">
							        	...
							        	<thead>
							        		<tr style="font-size: 12px;">
							        			...
							        			<th rowspan="2" class="sticky-1Cx" style="text-align: center; border: solid; border-width: 1px; background-color: #37393c; border-color: #ffffff; color: #ffffff; vertical-align: middle; min-width: 80px;">
							        				Peso Salida<br>AUM (TMH)
							        			</th>

							        			<th colspan="12" class="sticky-1Cx" style="text-align: center; border: solid; border-width: 1px; background-color: #D9D2D0; border-color: #ffffff; color: #37393c; vertical-align: middle;">
							        		...
							        		<tr style="font-size: 12px;">
							        			...
							        			<th class="sticky-2Cxa" style="text-align: center; border: solid; border-width: 1px; background-color: #D9D2D0; border-color: #ffffff; color: #37393c; vertical-align: middle; min-width: 110px;">
							        				Código Planta
							        			</th>

							        			<th class="sticky-2Cxa" style="text-align: center; border: solid; border-width: 1px; background-color: #D9D2D0; border-color: #ffffff; color: #37393c; vertical-align: middle; min-width: 100px;">
							        			...
							        			<th class="sticky-2Cxa" style="text-align: center; border: solid; border-width: 1px; background-color: #D9D2D0; border-color: #ffffff; color: #37393c; vertical-align: middle; min-width: 120px;">
							        			...
							        			<th class="sticky-2Cxa" colspan="2" style="text-align: center; border: solid; border-width: 1px; background-color: #D9D2D0; border-color: #ffffff; color: #37393c; vertical-align: middle; min-width: 80px;">
