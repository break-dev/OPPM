...
<html lang="es">
	<head>
		...
		<title><?php echo $nom_app; ?> | Recepción de Muestras</title>
	...
	<body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
				...
				<div class="col-md-11 col-sm-11 col-xs-11" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px;">
					<div class="d-flex row">
						<div class="col-md-4 col-sm-4 col-xs-12" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #ffffff;">
							<div class="row" style="font-size: 18px; border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #5b2a68; color: #ffffff; text-align: center; margin-bottom: 10px;">
							...
							<div id="div_cabecera" class="row" style="text-align: center; margin-top: 10px; display: none;">
								...
								<div class="row" style="padding: 5px; margin-left: 5px;">
									...
									<div class="col-md-8 col-sm-8 col-xs-8">
										<div class="row">
											<div class="col-md-7 col-sm-7 col-xs-7">
												<input id="cab_fechaentrega" type="date" class="form-control col-md-12 col-xs-12" style="text-align: center; width: 95%;" onblur="f_GrabarCabeceraRecepcion_Temporal();">
											</div>

											<div class="col-md-5 col-sm-5 col-xs-5">
												<input id="cab_horaentrega" type="time" class="form-control col-md-12 col-xs-12" style="text-align: center;" onblur="f_GrabarCabeceraRecepcion_Temporal();">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row" style="padding: 5px; margin-left: 5px;">
									...
									<div class="col-md-5 col-sm-5 col-xs-5">
										<input id="cab_clientedocumento" type="number" class="form-control obj_cab col-md-12 col-xs-12" style="text-align: center;" onkeyup="f_BuscarClientes();" onblur="f_GrabarCabeceraRecepcion_Temporal();">
									</div>

									<div class="col-md-1 col-sm-1 col-xs-1" style="margin-top: 2px; margin-right: 10px;">
										<img src="<?php echo $url_images.'search.png' ?>" class="obj_cab_img" style="width: 35px; cursor: pointer;" onclick="f_GetListaBuscarClientes();" data-bs-toggle="modal" data-bs-target="#modal_buscarcliente">
									</div>

									<div class="col-md-1 col-sm-1 col-xs-1" style="margin-top: 2px;">
										<img src="<?php echo $url_images.'add_new.png' ?>" class="obj_cab_img" style="width: 35px; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#modal_addcliente">
									</div>
								</div>
			          ...
			          <div id="div_grabarcabecera" class="row" style="padding-left: 30px; padding-right: 30px; padding-top: 10px; padding-bottom: 20px; text-align: center; display: none !important;">
				          ...
				          <div class="col-md-6 col-sm-6 col-xs-6">
										<button id="btn_RegresarRecepcion" class="btn btn-dark" type="button" onclick="f_RegresarRecepcion();" style="width: 100%; color: #ffffff;">
				              <b>Regresar</b>
				            </button>
				          </div>
			          </div>
						...
						<div class="col-md-8 col-sm-8 col-xs-12" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #736E66;">
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12" style="font-size: 18px; border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #5b2a68; color: #ffffff; text-align: center;">
								...
								<div id="div_detalle" class="row" style="text-align: center; margin-top: 10px; display: none;">
									<div class="col-md-4 col-sm-4 col-xs-4">
										<div class="col-md-12 col-sm-12 col-xs-12" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; text-align: center; background-color: #ffffff; width: 105%; margin-bottom: 10px;">
											<div class="d-flex" style="padding: 10px; font-size: 14px;">
												<label style="padding-top: 9px;">
													Agregar: 
												</label>

												<input id="det_nummuestras" type="number" class="form-control" style="text-align: center; margin-left: 10px; margin-right: 10px;" min="1" max="100">

												<label style="padding-top: 9px; margin-right: 10px; font-size: 14px;">
													muestra(s)
												</label>

												<button id="btn_AddMuestras" class="btn btn-primary" type="button" onclick="f_Addmuestras();" style="width: 100%; color: #ffffff; font-size: 14px;">
						              <b>Confirmar</b>
						            </button>
											</div>

											<div class="d-flex" style="padding: 10px; font-size: 14px; margin-top: -10px;">
												<label style="padding-top: 9px;">
													Eliminar: 
												</label>

												<input id="det_nummuestras_eliminar" type="number" class="form-control" style="text-align: center; margin-left: 10px; margin-right: 10px;" min="1" max="100">

												<label style="padding-top: 9px; margin-right: 10px; font-size: 14px;">
													muestra(s)
												</label>

												<button id="btn_DelMuestras" class="btn btn-danger" type="button" onclick="f_Delmuestras();" style="width: 100%; color: #ffffff; font-size: 14px;">
						              <b>Confirmar</b>
						            </button>
											</div>
		  ...
		  <div class="modal-dialog" style="margin-top: 10%;">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		      	...
		      	<button id="btn_insporconfirmar_clientecredito" type="button" class="btn btn-danger" style="margin-left: 5px;" onclick="f_GenerarInstruccion(0);">Por Confirmar</button>
		      </div>
		    </div>
		  </div>
		</div>
		...
		<div class="modal fade modal-dialog-scrollable" id="modal_ampliacion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal_ampliacionLabel" aria-hidden="true">
		  <div class="modal-dialog modal-xl">
		    <div class="modal-content">
		      ...
		      <input id="hd_idventaampliacion" type="hidden">
		...
		<script type="text/javascript">
			function f_Init(){
				...
				// Generar Id de Recepcion Preliminar
					// f_GetIdRecepcion();
					f_VerificaNuevaRecepcion();
			}
		</script>

		<!-- Funciones Principales -->
		<script type="text/javascript">
			function f_VerificaNuevaRecepcion(){
				$.post( "apis/backend.php", { accion: "verifica_NuevaRecepcion" }, 
					function( data ) {
						if(data.estado == 1 || data.estado == 2){
							if (data.id_recepcion == 0){
								$("#div_cabecera_prev").show();
								$("#div_cabecera").hide();
							}
							else{
								...
								// Verifica si se continua una ampliación
									if (data.is_ampliacion_de > 0){
										window.open('recepcion_ensayos_ampliacion.php?x=' + data.is_ampliacion_de + '&r=' + data.id_recepcion + '&d=' + data.ampliacion_idmuestras, '_self');
							...
							alert("Ocurrió un error al momento de verificar el Id de la recepción.");
						}
          ...
          _tr += '  </td>';
			...
			function f_ImprimirTickets(){
				var url = 'print_etiquetas_ensayos_ok.php?x=' + id_md5 + '&d=0';
			...
			function f_GenerarInstruccion(_is_instruccion){
				if (_is_instruccion == 0){
					// Grabar Preventa (POR PAGAR)
						...
						$.post( "apis/backend.php", { accion: "grabar_PreVentaSinInstruccion", id_recepcion: id_recepcion, cod_sucursal: cab_sucursal_x, cli_tienecredito: cli_tienecredito }, 
							function( data ) {
								if(data.estado == 1){
									f_ImprimirRecibo(0);
    	...
    	function f_CalcularExceso(){
  		...
  		function f_GetListaMuestrasAmpliacion(_item, _id_venta){
  			...
  			// Setea el código de la Venta (Recepción)
					$("#hd_idventaampliacion").val(_id_venta);
          ...
          $("#tr_VentaAmpliacion_" + _item).css('background-color', '#FFF587');
			...
			function f_IniciarAmpliacion(){
				// Valida que se haya seleccionado al menos 1 item
					var i = 1;
					var arr_muestras = '';

					$('#tbl_muestrasampliacion tr').each(function () {
    				if ($("#chk_itemmuestrasampliacion_" + i).prop('checked')){
    					arr_muestras += $("#id_muestraampliacion_" + i).val().trim() + '|';
    				}
          ...
          if (arr_muestras.length == 0){
          	alert("Debe seleccionar al menos una muestra.");

          	return;
          }
          else{
          	arr_muestras = arr_muestras.substring(0, arr_muestras.length - 1);
          }

        // Cargando el módulo de Ampliación
        	window.open('recepcion_ensayos_ampliacion.php?x=' + $("#hd_idventaampliacion").val() + '&r=0&d=' + arr_muestras, '_self');
			}
		</script>
      ...
      // Loading de Confirmación de Instrucción
		...
		<script type="text/javascript">
            ...
            $.post( "apis/backend.php", { accion: "grabar_CabeceraRecepcion_Temporal", id_recepcion: id_recepcion, codigo_interno: codigo_interno, fecha_recepcion: fecha_recepcion, hora_recepcion: hora_recepcion, fecha_entrega: fecha_entrega, hora_entrega: hora_entrega, documento: documento, razon_social: razon_social, entregado_por: entregado_por, celular_areportar: celular_areportar, cod_sucursal: cod_sucursal, cod_moneda: cod_moneda, observacion: observacion, tiene_recojo: tiene_recojo, cli_tienedscto: cli_tienedscto, dscto_porc: dscto_porc, cli_tienecredito: cli_tienecredito },
              function( data ) {
                if(data.estado == 0){
							...
							function( data ) {
								if(data.estado == 1){
									...
									// Si es Cliente con Crédito
										...
										$("#btn_insporconfirmar_clientecredito").hide();
										...
										if (cli_tienecredito == 1){
											...
											$("#btn_insporconfirmar_clientecredito").show();
