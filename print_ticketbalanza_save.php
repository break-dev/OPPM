<?php
  ...
  // Ruta logo
    ...
    $ruta_images = substr($ruta_images, 0, strpos($ruta_images, 'print_ticketbalanza_save.php')).'images/';
...
// return;
  ...
  // Verificando la ruta donde se almacenarán los archivos
    $carpeta_main = 'files/tickets_balanza/'.$cod_lote.'/INGRESO AUM/';
  ...
  // Identificando el nombre del archivo
    $nombre_archivo = 'INGRESO AUM - '.$cod_lote.((strlen($lote_ticket_orden) == 0) ? '' : ' - PARTE '.$lote_ticket_orden);
