...
<body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
				...
				<div class="d-flex row">
					<div class="row" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #ffffff; margin-bottom: 5px;">
						<div class="d-flex" style="padding-top: 10px; padding-left : 20px; padding-right: 20px;">
							...
							<input id="hd_is_segundo_tramo" value="1" hidden>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="d-flex" style="padding: 5px; margin-top: -10px;">
						...
						<input id="verif_codlote" type="text" class="form-control guia_GRT" style="text-align: center; font-size: 14px; text-transform: uppercase; font-weight: bold; width: 80px;" disabled>
			...
			$.post("apis/backend.php", {
				...
				function(data) {
					if (data.estado == 1) {
						...
						if (sin_GRT == 0) {
							url = 'print_segundotramo_guiat.php?x=' + data.id_distribucionunidad + '&a=' + data.gt_serie + '&b=' + data.gt_numero;
							window.open(url, '_blank');
						}
	...
	<script type="text/javascript">
		...
		function f_LoadCabeceraProcesos(){
			...
			var is_segundo_tramo = $("#hd_is_segundo_tramo").val();
			...
			$.post( "apis/backend.php", { accion: "get_ListaCabeceraControlInternoProcesosTramos", id_origendato:id_origendato, is_segundo_tramo:is_segundo_tramo}, 
				function( data ) {
					if(data.estado == 1){
		...
		function f_LoadCabeceraDetalles(arr_id_proceso){
			...
			$.post( "apis/backend.php", { accion: "get_ListaCabeceraControlInternoDetallesTramos", arr_id_proceso: arr_id_proceso,is_segundo_tramo:is_segundo_tramo}, 
				function( data ) {
					if(data.estado == 1){
		...
		function f_DescargarZIPGestionDocumentariaVerificacion(){
			...
			$.post( "apis/backend.php", { accion: "get_ZipGestionDocumentariaVerificacion", cod_lote:cod_lote,id_origendato:id_origendato,is_segundo_tramo: is_segundo_tramo }, 
			function( data ) {
				if(data.estado == 1){

					var segundo_tramo = "";

					if(is_segundo_tramo == "1"){
						segundo_tramo = "2doTramo";
					}

					console.log(segundo_tramo);

					var nombre_archivo_zip = cod_lote+"_"+segundo_tramo+'.zip';
					var link = document.createElement('a')
