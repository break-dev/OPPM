	...
	<div class="container-fluid" id="content">
		...
		<script type="text/javascript">
			...
			function f_LoadResultados(){
				...
				$.post( "apis/backend.php", { accion: "get_ListaDetalleControlInternoPlanta", filtro_tipocliente: filtro_tipocliente, filtro_cliente: filtro_cliente, id_origendato: id_origendato, filtro_porcentaje: filtro_porcentaje }, 
					function( data ) {
						if(data.estado == 1){
							...
							$.each( data.res, function( key, val ) {
								...
								_html += ' <button class="btn btn-primary " type="button" title="Resumen" style="font-size: 14px; padding: 5px; width: 30px; margin-bottom: 5px" onclick="f_ReporteGestionDocumentaria('+val.Id+", '"+val.documento+"','"+val.razon_social+"'"+')">'
								...
								_html += ' </button>'
 								...
 								_html += ' <button class="btn btn-danger " type="button" title="Descargar ZIP" style="font-size: 14px; padding: 5px; width: 30px;margin-bottom: 5px" onclick="f_DescargarZIPGestionDocumentaria('+val.Id+", '"+val.documento+"'"+')">'
								...
								_html += '  <td class="row-sticky-6" style="border: solid; border-width: 1px; border-color: #D9D9D9; vertical-align: middle;background-color: #dbdbdb">';
		...
		// Actualizar registros input
			...
			function f_TotalLoadGestionDocumentaria(_id_cliente){
				$.post( "apis/backend.php", { accion: "get_TotalControlInternoGestionDocumentariaDetalle", id_cliente: _id_cliente, id_origendato: 4}, 
					function( data ) {
						if(data.estado == 1){
							...
							//Calcular el porcentaje de avance
								...
								if(porcentaje_cliente >= 100){
									...
									//Grabar el estado del porcentaje
										$.post( "apis/backend.php", { accion: "actualizar_EstadoPorcentajeCliente", estado_porcentaje: 'C', id_cliente: _id_cliente, nombre_tabla: 'tbconfig_plantas', nombre_id : 'Id'},
											function( data ) {
												if(data.estado == 1){
												}
												else{
									...
									//Grabar el estado del porcentaje
										$.post( "apis/backend.php", { accion: "actualizar_EstadoPorcentajeCliente", estado_porcentaje: 'I', id_cliente: _id_cliente, nombre_tabla: 'tbconfig_plantas', nombre_id: 'Id'},
											function( data ) {
												if(data.estado == 1){
												}
												else{
