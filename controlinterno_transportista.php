...
<section>
	<div class="container-fluid" id="content">
					...
					function( data ) {
						if(data.estado == 1){
							...
							$.each( data.res, function( key, val ) {
								...
								// _html += '  <td style="border: solid; border-width: 1px; border-color: #D9D9D9; vertical-align: middle; text-align: center;background-color: #dbdbdb">';
											...
											$.ajax({
												...
												success: function(data3) {
													if (data3.estado == 1) {
														...
														array_valor_tipo_dato += valor_tipo_dato +"$";
		...
		function f_TotalLoadGestionDocumentaria(_id_cliente){
			$.post( "apis/backend.php", { accion: "get_TotalControlInternoGestionDocumentariaDetalle", id_cliente: _id_cliente, id_origendato: 2}, 
				function( data ) {
					if(data.estado == 1){
