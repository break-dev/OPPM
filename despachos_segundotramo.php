...
<body class="bg-light" onload="f_SetDimension(); f_Init();" style="zoom: 80%;">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="row">
				<!-- Menús principales -->
				<div id="div_menu1" class="col-md-1 col-sm-1 col-xs-12"
					style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; text-align: center; background-color: #DEDEDE;">
				...
				<div class="col-md-11 col-sm-11 col-xs-12"
					...
					<div class="d-flex row">
							...
							<div class="row"
								...
								<div class="col-md-3 col-sm-3 col-xs-12" style="padding: 2px;">
									<div
										...
										<div class="d-flex"
											...
											<select id="filtro_transportista" class="form-select obj_cab"
								...
								<div class="col-md-2 col-sm-2 col-xs-12" style="padding: 2px;">
									<div
										...
										<div class="d-flex"
											style="margin-top: -5px; padding-left: 10px; padding-right: 10px;">
											<input id="filtro_placa" type="text" class="form-control"
								...
								<div class="col-md-2 col-sm-2 col-xs-12" style="padding: 2px;">
									<div
										...
										<div class="d-flex"
											style="margin-top: -5px; padding-left: 10px; padding-right: 10px;">
											<input id="filtro_lote" type="text" class="form-control"
												style="font-size: 14px;">
										</div>
									</div>
								</div>
						...
						<div class="row"
							style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px;">
									...
									<thead>
										<tr style="font-size: 12px;">
											<th rowspan="2" rowspan="2"
												style="text-align: center; border: solid; border-width: 1px; background-color: #37393c; border-color: #ffffff; color: #ffffff; vertical-align: middle; min-width: 80px; border-top-left-radius: 15px;">
												N°
											</th>
											...
											<th rowspan="2"
												style="text-align: center; border: solid; border-width: 1px; background-color: #37393c; border-color: #ffffff; color: #ffffff; vertical-align: middle; min-width: 140px;">
												Tipo Vehículo
											</th>
											...
											<th rowspan="2"
												style="text-align: center; border: solid; border-width: 1px; background-color: #37393c; border-color: #ffffff; color: #ffffff; vertical-align: middle; min-width: 250px; border-top-right-radius: 15px;">
												Observación
											</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<div id="div_recepcion1">
						<div class="row"
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<select id="registro_condicion" class="form-select" style="text-align: left;"
									onchange="f_LoadListaTipoCarga();">
									...
									if ($res_tipocarga = mysqli_query($enlace, $q_tipocarga)) {
										if (mysqli_num_rows($res_tipocarga) > 0) {
											while ($row_tipocarga = mysqli_fetch_array($res_tipocarga)) {
												...
												<option value="<?php echo $row_tipocarga["Id"]; ?>">
													<?php echo $row_tipocarga["descripcion"]; ?></option>
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="d-flex">
									<div class="flex-fill" style="max-width: 90%">
										<select id="registro_transportista" class="form-select"
									...
									<div class="col-md-2 col-sm-2 col-xs-2">
										<button type="button" class="btn" onclick="f_AddTransportista();"
						...
						<div class="row" style="padding: 5px;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<select id="registro_tipovehiculo" class="form-select"
									data-placeholder="Elija una opción..." onchange="f_TieneCarreta();">
									<option selected value="">Elija una opción...</option>
									<option value="x" style="font-size: 6px;" disabled></option>
									...
									if ($res_tipovehiculo = mysqli_query($enlace, $q_tipovehiculo)) {
										if (mysqli_num_rows($res_tipovehiculo) > 0) {
											while ($row_tipovehiculo = mysqli_fetch_array($res_tipovehiculo)) {
												...
												<option
													value="<?php echo $row_tipovehiculo["Id"] . '|' . $row_tipovehiculo["tiene_carreta"]; ?>">
						...
						<div id="div_placa2" class="row" style="padding: 5px; display: none;">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="d-flex">
									...
									<div class="col-md-5 col-sm-5 col-xs-5">
										<label
											style="margin-left: 5px; margin-top: 10px; font-size: 14px;"><i>(Remolque)</i></label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row" style="padding: 5px;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="d-flex">
									<div class="flex-fill" style="max-width: 90%">
										<select id="registro_conductor" class="form-select"
											data-placeholder="Elija una opción...">
						...
						<div class="row" style="padding: 5px;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<select id="registro_tipocarga" class="form-select"
									data-placeholder="Elija una opción...">
						...
						<div id="div_zonaorigen" class="row" style="padding: 5px; display: none;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="d-flex">
									<div class="flex-fill" style="max-width: 90%">
										<select id="registro_zonaorigen" class="form-select"
											data-placeholder="Elija una opción...">
						...
						<div class="row" style="padding: 5px;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<textarea id="registro_observacion" type="text" class="form-control col-md-12 col-xs-12"
						...
						<div class="row" style="padding: 5px;">
							<table class="table table-bordered table-hover">
								<thead>
									<tr style="font-size: 12px;">
										<th colspan="3"
											style="text-align: center; border: solid; border-width: 1px; background-color: #37393c; border-color: #ffffff; color: #ffffff; vertical-align: middle; border-top-left-radius: 15px; border-top-right-radius: 15px;">
				...
				<div class="modal-footer">
					...
					<button id="btn_Regresar_2" type="button" class="btn btn-dark wt_grabarregistro_button"
						style="display: none; font-size: 14px;" onclick="f_RegresarRecepcion(2);">Regresar</button>
					<button id="btn_Regresar_3" type="button" class="btn btn-dark wt_grabarregistro_button"
						style="display: none; font-size: 14px;" onclick="f_RegresarRecepcion(3);">Regresar</button>
					<button id="btn_Next_1" type="button" class="btn btn-warning wt_grabarregistro_button"
						style="font-size: 14px;" onclick="f_GrabarRecepcion_Next(1);">Continuar</button>
					<button id="btn_Next_2" type="button" class="btn btn-warning wt_grabarregistro_button"
						style="display: none; font-size: 14px;" onclick="f_GrabarRecepcion_Next(2);">Continuar</button>
					<button id="btn_ConfirmarAcompanantes" type="button" class="btn btn-danger wt_grabarregistro_button"
						style="display: none; font-size: 14px;" onclick="f_GrabarRecepcion_Confirmar();">Finalizar y
						Confirmar</button>
				</div>
			</div>
		</div>
			...
			<div id="modal_addcliente_content" class="modal-content" style="margin-top: 250px;">
				...
				<div class="modal-body">
								...
								if ($res_tipocliente = mysqli_query($enlace, $q_tipocliente)) {
									if (mysqli_num_rows($res_tipocliente) > 0) {
										while ($row_tipocliente = mysqli_fetch_array($res_tipocliente)) {
											...
											<option value="<?php echo $row_tipocliente["Id"]; ?>">
												<?php echo $row_tipocliente["descripcion"]; ?></option>
								...
								if ($res_tipodocumento = mysqli_query($enlace, $q_tipodocumento)) {
									if (mysqli_num_rows($res_tipodocumento) > 0) {
										while ($row_tipodocumento = mysqli_fetch_array($res_tipodocumento)) {
											...
											<option value="<?php echo $row_tipodocumento["Id"]; ?>">
												<?php echo $row_tipodocumento["descripcion"]; ?></option>
					...
					<div class="row" style="padding: 5px;">
						...
						<div class="col-md-8 col-sm-8 col-xs-8">
							<textarea id="cliente_razonsocial" type="text" class="form-control col-md-12 col-xs-12"
								rows="2" style="text-transform: uppercase;"></textarea>
						</div>
					</div>
					...
					<div class="row" style="padding: 5px;">
						...
						<div class="col-md-8 col-sm-8 col-xs-8">
							<textarea id="cliente_direccion" type="text" class="form-control col-md-12 col-xs-12"
								rows="2" style="text-transform: uppercase;"></textarea>
						</div>
					</div>
				</div>
			...
			<div id="modal_addconductor_content" class="modal-content" style="margin-top: 346px;">
				...
				<div class="modal-body">
					<div class="row" style="padding: 5px;">
						...
						<div class="col-md-8 col-sm-8 col-xs-8">
							<input id="conductor_dni" type="text" class="form-control col-md-12 col-xs-12"
								style="text-align: center;" onkeyup="f_GetInfoCliente(2);">
						</div>
					</div>

					<div class="row" style="padding: 5px;">
						<div class="col-md-4 col-sm-4 col-xs-4" style="padding: 5px;">
							Nombres: <img id="wt_conductor" src="<?php echo $img_waiting ?>"
								style="width: 35px; display: none;">
						</div>
		...
		<div class="modal-dialog">
			<div id="modal_addacompanante_content" class="modal-content" style="margin-top: 225px;">
				...
				<div class="modal-body">
					...
					<div class="row" style="padding: 5px;">
						<div class="col-md-4 col-sm-4 col-xs-4" style="padding: 5px;">
							Nombres: <img id="wt_acompanante" src="<?php echo $img_waiting ?>"
								style="width: 35px; display: none;">
						</div>
					...
					<div>
						...
						<div class="row" style="padding: 5px;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								...
								<textarea id="info_transportista" type="text" class="form-control col-md-12 col-xs-12"
									rows="2"
						...
						<div class="row" style="padding: 5px;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<textarea id="info_observacion" type="text" class="form-control col-md-12 col-xs-12"
									rows="2" style="font-size: 14px; text-transform: uppercase; font-weight: bold;"
									disabled></textarea>
							</div>
						</div>
						...
						<div class="row" style="padding: 5px; display: none;">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input id="chk_tienevehiculoparticular" class="form-check-input obj_cab" type="checkbox"
									disabled>
						...
						<div class="row" style="padding: 5px; display: none;">
							<table class="table table-bordered table-hover">
								<thead>
									...
									<tr style="font-size: 12px;">
										<th
											style="text-align: center; border: solid; border-width: 1px; background-color: #37393c; border-color: #ffffff; color: #ffffff; vertical-align: middle; width: 60px;">
											N°
										</th>
			...
			<div id="modal_registrosalida_content" class="modal-content" style="margin-top: 100px;">
				...
				<div class="modal-body">
								...
								if ($res_estadossalida = mysqli_query($enlace, $q_estadossalida)) {
									if (mysqli_num_rows($res_estadossalida) > 0) {
										while ($row_estadossalida = mysqli_fetch_array($res_estadossalida)) {
											...
											<option value="<?php echo $row_estadossalida["Id"]; ?>">
												<?php echo $row_estadossalida["descripcion"]; ?></option>
					...
					<div class="row" style="padding: 5px;">
						...
						<div class="col-md-8 col-sm-8 col-xs-8">
							<textarea id="salida_observacion" type="text" class="form-control col-md-12 col-xs-12"
								rows="2" style="text-transform: uppercase;"></textarea>
						</div>
					</div>
					...
					<div class="row" style="padding: 5px; margin-top: -10px;">
						<div id="wt_loadingacompanantes" class=""
							style="font-size: 12px; text-align: center; display: none; padding-top: 5px; margin-top: -10px;">
							<img src="<?php echo $img_waiting ?>" style="width: 20px;">
							<label style="font-style: italic;"> Cargando datos...</label>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-secondary wt_grabarsalida_button"
	...
	<div class="modal fade" id="modal_getpeso" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="modal_getpesoLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content" style="width: 120%;">
				...
				<div class="modal-body">
					<div id="div_pesoinicial"
						style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px; background-color: #f0efe8; padding: 5px; margin-bottom: 5px;">
						<div class="d-flex" style="padding: 5px;">
							<div class="col-md-3 col-sm-3 col-xs-3"
								style="padding: 5px; font-weight: bold; font-size: 14px; text-align: center;">
								Peso:
							</div>

							<div class="col-md-5 col-sm-5 col-xs-5">
								<input id="lote_peso" type="number"
									class="form-control obj_cab col-md-12 col-xs-12 show_peso"
								...
								<div class="d-flex justify-content-center" style="margin-left: 10px; margin-top: 7px;">
									<div class="form-check form-switch">
										<input class="form-check-input" type="checkbox" role="switch"
											id="chk_InterfazAuto" onchange="f_getPeso(1);" checked>
										<label id="lbl_getpeso_check" class="form-check-label"
											for="chk_InterfazAuto">Auto.</label>
									</div>
								</div>
							</div>
						</div>

						<div id="div_SinConexion" class="col-md-10 col-sm-10 col-xs-10"
				...
				<div class="modal-footer">
					<div id="wt_grabarpeso" class=""
						style="font-size: 12px; text-align: center; display: none; padding-top: 5px;">
						<img src="<?php echo $img_waiting ?>" style="width: 20px;">
						<label style="font-style: italic;"> Grabando datos...</label>
					</div>

					<button type="button" class="btn btn-secondary wt_grabarpeso_button" data-bs-dismiss="modal"
						style="font-size: 14px;" onclick="f_GetPesoCerrar();">Cerrar</button>

					<button type="button" class="btn btn-warning wt_grabarpeso_button" style="font-size: 14px;"
						onclick="f_ConfirmarPeso();">Confirmar</button>
				</div>
			</div>
		</div>
	</div>

	<div class="modal fade" id="modal_editinfo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="modal_editinfoLabel" aria-hidden="true">
		<div class="modal-dialog">
					...
					<div class="row" style="padding: 5px; margin-left: 40px; margin-right: 40px;">
						<div class="flex-fill justify-content-center">
							<div id="div_lista" style="padding: 0px;">
								<select id="edit_Lista" class="form-select select_datos"
									data-placeholder="Elija una opción...">

								</select>
							</div>

							<input id="edit_InputText" type="text" class="form-control col-md-12 col-xs-12"
								style="text-align: center; text-transform: uppercase;">

							<input id="edit_InputNumber" type="number" class="form-control col-md-12 col-xs-12"
								style="text-align: center;">
						</div>
					</div>
				</div>
