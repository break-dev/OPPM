...
<head>
	...
	<title><?php echo $nom_app; ?> | Cumplimiento - Comisión</title>
...
<section>
	<div class="container-fluid" id="content">
							...
							<div class="row" style="border: solid; border-width: 1px; border-color: #E6E9ED; border-radius: 7px;">
								...
								<div class="col-md-12 col-sm-12 col-xs-12" style="padding: 20px; margin-top: -15px; overflow-x: scroll; width: 100%;">
									...
									<div class="table-container" style="margin-top: 5px;overflow-x: scroll;width: 100%;height: 750px;margin-bottom: 20px;">
										<input id="hd_id_origendato" type="hidden" value="6">
		...
		<script type="text/javascript">
			...
			// Titulo de Pantalla
				$("#nv_titulo").html('| Cumplimiento - Comisión');
		...
		<script type="text/javascript">
			...
			function f_LoadResultados(){
				...
				$.post( "apis/backend.php", { accion: "get_ListaDetalleControlInternoComision", filtro_planta: filtro_planta, id_origendato: id_origendato, filtro_porcentaje: filtro_porcentaje,filtro_lote: filtro_lote, fecha_inicio: fecha_inicio, fecha_fin: fecha_fin,filtro_codigo_despacho: filtro_codigo_despacho }, 
					function( data ) {
						if(data.estado == 1){
