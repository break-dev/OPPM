<?php
  ...
  //   									 C.fechahora_recepcion,
	...
	// 				// Recuperando valores
	// 					$fecha_recepcion = explode('-', explode(' ', $row_datos["fechahora_recepcion"])[0])[2].'/'.
	// 														 explode('-', explode(' ', $row_datos["fechahora_recepcion"])[0])[1].'/'.
	// 														 explode('-', explode(' ', $row_datos["fechahora_recepcion"])[0])[0];
	// 					$hora_recepcion = substr(explode(' ', $row_datos["fechahora_recepcion"])[1], 0, 5);
	...
	// 					barcode( 'images/bc/'.$CI.'.png', '$CI', 20, 'horizontal', 'code128', false );
	// 					// barcode( 'images/bc/'.$CI.', '1000', 20, 'horizontal', 'code128', false );
...
// return;
  ...
  $document = new Dompdf($options);
	...
	$document -> setPaper(array(0, 0, 289, 77));
	$document -> render();
